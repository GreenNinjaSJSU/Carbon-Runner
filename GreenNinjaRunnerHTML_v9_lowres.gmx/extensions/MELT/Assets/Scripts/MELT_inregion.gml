///MELT_inregion(x,y,x1,y1,x2,y2,relative)
//param#        0 1 2  3  4  5  6
//@author Arthur Baney
...
var rel = argument6                         //relative

if (rel)                                //if relative
    {
    var xc = (argument2 + argument4 / 2);   //region x-center
    var w = argument4;                      //region width
    var yc = (argument3 + argument5 / 2);   //region y-center
    var h = argument5;                      //region height
    ...
    {
    var xc = (argument2 + argument4) / 2;   //region x-center
    var w = abs(argument2-argument4);       //region width
    var yc = (argument3 + argument5) / 2;   //region y-center
    var h = abs(argument3-argument5);       //region height
